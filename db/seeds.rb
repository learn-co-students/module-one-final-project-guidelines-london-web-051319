...
concert9 = Concert.create(name: "Mindgoogling", price: 70.00, website_url: "TBC", artist_id: bill.id, venue_id: albert.id)
...
concert13 = Concert.create(name: "Fractured Future Tour: London", price: 90.00, website_url: "TBC", artist_id: muse.id, venue_id: wembley.id)
...
concert17 = Concert.create(name: "Mindgoogling", price: 70, website_url: "TBC", artist_id: bill.id, venue_id: o2_newc.id)
